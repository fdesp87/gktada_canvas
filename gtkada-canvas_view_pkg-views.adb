...
package body Gtkada.Canvas_View_Pkg.Views is
   ...
   begin
      ...
      then
         ...
         --  JLF 2023-09-03 Event.Allowed_Drag_Area := Drag_Anywhere;
   ...
   procedure Gtk_New
     (Self  : out Minimap_View;
      Style : Gtkada.Style_Pkg.Drawing_Style := Default_Current_Region_Style)
   is
   begin
      Self := new Minimap_View_Record;
      Initialize (Self, Style);
   end Gtk_New;
   ...
   is
      ...
      Pos     : Gtkada.Style_Pkg.Point;
      Child   : Gtkada.Style_Pkg.Point; --  coordinates of first child
      Coord   : Gtkada.Style_Pkg.Point; --  coordinates of current child
      It      : Abstract_Item;
   begin
      ...
      if Horizontal then
         Reserve_Space
           (Self,
            ...
            Direction => Canvas_View_Pkg.Views.Horizontal,
            Duration  => Duration);
      else
         Reserve_Space
           (Self,
            (Child.X, Child.Y, Total, Max),
            Direction => Canvas_View_Pkg.Views.Vertical,
            Duration  => Duration);
      end if;
...
end Gtkada.Canvas_View_Pkg.Views;
