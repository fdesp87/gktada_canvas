...
------------------------------------------------------------------------------
------------------------------------------------------------------------------
-- Modified by JLF (fdesp87@gmail.com) to improve arrows.                   --
------------------------------------------------------------------------------
...
package body Gtkada.Style_Pkg is
   ...
   package Gdouble_Functions is new Ada.Numerics.Generic_Elementary_Functions
     (Gdouble);
   ...
   --
   --  function Img (D : Gdouble) return String;
   --  function Img (D : Gdouble) return String is
   --     Temp : String (1 .. 20);
   --  begin
   --     Gdouble_IO.Put (To => Temp, Item => D, Aft => 3, Exp => 0);
   --     return Ada.Strings.Fixed.Trim (Temp, Ada.Strings.Both);
   --  end Img;
   -----------------------------------------------------------------------
   ...
   begin
      if Color.Saturation = 0.0 then
         return
           (Red  => Color.Lightness, Green => Color.Lightness,
            Blue => Color.Lightness, Alpha => Color.Alpha);
      end if;
      ...
      return
        (Red   => Hue_To_RGB (Color.Hue + 1.0 / 3.0),
         Green => Hue_To_RGB (Color.Hue),
         Blue  => Hue_To_RGB (Color.Hue - 1.0 / 3.0), Alpha => Color.Alpha);
   end To_RGBA;
   ...
   function To_Cairo (HSV : HSV_Color) return Cairo_Color is
   ...
   begin
      return
        (Red   => Gdouble (Gdk.Color.Red (Color)) / 65_535.0,
         Green => Gdouble (Gdk.Color.Green (Color)) / 65_535.0,
         Blue  => Gdouble (Gdk.Color.Blue (Color)) / 65_535.0, Alpha => 1.0);
   end To_Cairo;
   ...
   function Complementary (Color : Gdk.RGBA.Gdk_RGBA) return Gdk.RGBA.Gdk_RGBA
   is
   ...
   function Shade_Or_Lighten
     (Color : Gdk.RGBA.Gdk_RGBA; Amount : Percent := 0.4)
      return Gdk.RGBA.Gdk_RGBA
   is
      V : HSLA_Color := To_HSLA (Color);
   begin
      if V.Lightness < 0.5 then
         V.Lightness := Gdouble'Min (1.0, V.Lightness + Amount);   --  lighten
      else
         V.Lightness := Gdouble'Max (0.0, V.Lightness - Amount);   --  darken
      end if;
      return To_RGBA (V);
   ...
   function Shade
     (Color : Gdk.Color.Gdk_Color; Value : Percent) return Cairo_Color
   is
   begin
   ...
   function Shade (Color : Cairo_Color; Value : Percent) return Cairo_Color is
      V : HSLA_Color := To_HSLA (Color);
   begin
   ...
   procedure Set_Source_Color (Cr : Cairo.Cairo_Context; Color : Cairo_Color)
   is
   begin
   ...
   procedure Rounded_Rectangle
     (Cr     : Cairo.Cairo_Context; X, Y, W, H : Glib.Gdouble;
      Radius : Glib.Gdouble)
   is
   ...
   procedure Draw_Shadow
     (Cr            : Cairo.Cairo_Context;
      ...
      Shadow_Type : Gtk.Enums.Gtk_Shadow_Type; X, Y, Width, Height : Glib.Gint;
   ...
   begin
      ...
      Rounded_Rectangle (Cr, dX, dY, dW, dH, Radius);
      Cairo.Stroke (Cr);
      ...
      Rounded_Rectangle
        (Cr, dX + X_Thick, dY + X_Thick, dW - 2.0 * X_Thick,
         dH - 2.0 * X_Thick, Radius - X_Thick * 1.0);
      Cairo.Stroke (Cr);
   ...
   procedure Draw_Rectangle
     (Cr : Cairo.Cairo_Context; Color : Gdk.Color.Gdk_Color; Filled : Boolean;
      X, Y, Width, Height : Glib.Gint; Corner_Radius : Glib.Gdouble := 0.0)
   is
   begin
      Draw_Rectangle
   ...
   procedure Draw_Rectangle
     (Cr : Cairo.Cairo_Context; Color : Cairo_Color; Filled : Boolean;
      X, Y, Width, Height : Glib.Gint; Corner_Radius : Glib.Gdouble := 0.0)
   is
      dX, dY, dW, dH : Gdouble;
      Line_Width     : Gdouble;
   ...
   procedure Draw_Line
     (Cr             : Cairo.Cairo_Context; Color : Gdk.Color.Gdk_Color;
   ...
   procedure Draw_Layout
     (Cr : Cairo.Cairo_Context; Color : Gdk.Color.Gdk_Color; X, Y : Glib.Gint;
   ...
   procedure Draw_Layout
     (Cr     : Cairo.Cairo_Context; Color : Cairo_Color; X, Y : Glib.Gint;
      Layout : Pango.Layout.Pango_Layout)
   is
   begin
      Set_Source_Color (Cr, Color);
   ...
   procedure Draw_Pixbuf
     (Cr   : Cairo.Cairo_Context; Pixbuf : Gdk.Pixbuf.Gdk_Pixbuf;
      X, Y : Glib.Gint)
   is
   begin
   ...
   procedure Draw_Pixbuf_With_Scale
     (Cr   : Cairo.Cairo_Context; Pixbuf : Gdk.Pixbuf.Gdk_Pixbuf;
      X, Y : Glib.Gdouble; Widget : access Gtk_Widget_Record'Class := null)
   is
      Scale : Gint;
      Surf  : Cairo_Surface;
   begin
      ...
      if Widget /= null then
         ...
         Surf := Create_From_Pixbuf (Pixbuf, Scale => 1, For_Window => null);
   ...
   procedure Draw_Pixbuf_With_Scale
     (Cr   : Cairo.Cairo_Context; Icon_Name : String; X, Y : Glib.Gdouble;
      Size : Glib.Gint; Widget : access Gtk_Widget_Record'Class := null)
   is
      use Gdk.Pixbuf;
   ...
   begin
      ...
      P :=
        Gtk.Icon_Theme.Get_Default.Load_Icon_For_Scale
          (Icon_Name, Size => Size, Scale => Scale, Flags => 0, Error => null);
      if P /= null then
   ...
   begin
      Surface :=
        Gdk.Window.Create_Similar_Surface
          (Self   => Get_Window (Widget), Content => Cairo_Content_Color,
           Width  => Get_Allocated_Width (Widget),
           Height => Get_Allocated_Height (Widget));

      while Window_Provider /= null and then not Window_Provider.Get_Has_Window
      loop
   ...
   procedure Draw_Overlay
     (Widget  :        not null access Gtk.Widget.Gtk_Widget_Record'Class;
      ...
      Do_Draw :        not null access procedure
        (Context : Cairo.Cairo_Context; Draw : Boolean))
   is
   ...
   begin
      ...
      if Overlay = Null_Surface then
         ...
         begin
            Overlay :=
              Gdk.Window.Create_Similar_Surface
                (Self   => Top_Win, Content => Cairo_Content_Color,
...
--              Cairo.Clip (Cr2);
   ...
   begin
      if Overlay /= Null_Surface then
         ...
         Gdk.Window.Invalidate_Rect
           (Widget.Get_Window,
            (0, 0, Widget.Get_Allocated_Width, Widget.Get_Allocated_Height),
            True);
      end if;
   end Delete_Overlay;
   ...
   function Lighten
     (Color : Gdk.RGBA.Gdk_RGBA; Amount : Percent) return Gdk.RGBA.Gdk_RGBA
   is
      V : HSLA_Color := To_HSLA (Color);
   begin
   ...
   -- Point Aritmethic --
   ----------------------
   function "+" (P, Q : Point) return Point is
   begin
      return (P.X + Q.X, P.Y + Q.Y);
   end "+";

   function "*" (K : Glib.Gdouble; P : Point) return Point is
   begin
      return (K * P.X, K * P.Y);
   end "*";

   function "*" (P : Point; K : Glib.Gdouble) return Point is
   begin
      return (K * P.X, K * P.Y);
   end "*";
   ...
   -------------------------------
   -- Arctan between two points --
   -------------------------------

   function Arctan (P1, P2 : Point) return Gdouble is
   begin
      if P1 = P2 then
         return 0.0;
      end if;
      ...
      return Arctan (Y => P1.Y - P2.Y, X => P1.X - P2.X);
   end Arctan;
   ...
   function Gtk_New
     (Stroke      : Gdk.RGBA.Gdk_RGBA   := Gdk.RGBA.Black_RGBA;
      ...
      Font : Font_Style := Default_Font; Line_Width : Glib.Gdouble := 1.0;
      ...
      Shadow      : Shadow_Style := No_Shadow; Sloppy : Boolean := False)
      return Drawing_Style
   is
      Data : constant Drawing_Style_Data_Access :=
        new Drawing_Style_Data'
          (Refcount => 1, Stroke => Stroke, Fill => Null_Pattern, Font => Font,
           Line_Width => Line_Width, Dashes => null, Arrow_From => Arrow_From,
           Arrow_To   => Arrow_To, Symbol_From => Symbol_From,
           Symbol_To  => Symbol_To, Shadow => Shadow, Sloppy => Sloppy);
   begin
      ...
      if Arrow_From.Length < 0.0 then
         Data.Arrow_From.Length := 0.0;
      end if;
      if Arrow_To.Length < 0.0 then
         Data.Arrow_To.Length := 0.0;
      end if;
   ...
   function Path_Rect
     (Self          : Drawing_Style; Cr : Cairo.Cairo_Context; Topleft : Point;
      Width, Height : Glib.Gdouble; Radius : Glib.Gdouble := 0.0)
      return Boolean
   is
   begin
      if Self.Data = null or else (Width = 0.0 and then Height = 0.0) then
         return False;
         ...
         if Self.Data.Sloppy then
            return
              Path_Polyline
                (Self, Cr,
                 ((Topleft.X, Topleft.Y), (Topleft.X + Width, Topleft.Y),
   ...
   procedure Draw_Rect
     (Self          : Drawing_Style; Cr : Cairo.Cairo_Context; Topleft : Point;
      Width, Height : Glib.Gdouble; Radius : Gdouble := 0.0)
   is
   begin
   ...
   function Path_Polyline
     (Self  : Drawing_Style; Cr : Cairo.Cairo_Context; Points : Point_Array;
      Close : Boolean := False; Relative : Boolean := False) return Boolean
   is
   ...
   begin
      ...
      if Self.Data /= null and then Self.Data.Sloppy then
         ...
         if Close
           or else
           (Self.Data /= null and then Self.Data.Fill /= Cairo.Null_Pattern)
         then
            Close_Path (Cr);
         end if;
      end if;
   ...
   procedure Draw_Polyline
     (Self     : Drawing_Style; Cr : Cairo.Cairo_Context; Points : Point_Array;
      Close    : Boolean := False; Show_Arrows : Boolean := True;
   ...
   procedure Draw_Polycurve
     (Self     : Drawing_Style; Cr : Cairo.Cairo_Context; Points : Point_Array;
      Routing  : Route_Style := Straight; Show_Arrows : Boolean := True;
      Relative : Boolean     := False)
   is
   begin
   ...
   procedure Draw_Arrows_And_Symbols
     (Self         : Drawing_Style;
      ...
      Points       : Point_Array;
      Relative     : Boolean;
      Side_From    : Side_Anchor_Style;
      Side_To      : Side_Anchor_Style;
      Routing      : Route_Style;
      No_Waypoints : Boolean)
   is
      procedure Draw_Arrow
        (Self  : Arrow_Style; Cr : Cairo.Cairo_Context; To : Point;
         Angle : Gdouble);
      ...
      -- Compute Angle --
      -------------------
      function Compute_Angle_From
        (P            : Point_Array; Relative : Boolean;
         Arrow_Len    : Gdouble;
         Arrow_Angle  : Gdouble;
         Routing      : Route_Style;
         No_Waypoints : Boolean) return Gdouble; --  radians
      ...
      function Compute_Angle_From
        (P            : Point_Array; Relative : Boolean;
         ...
         Arrow_Angle  : Gdouble;
         Routing      : Route_Style;
         No_Waypoints : Boolean) return Gdouble
      is
         pragma Unreferenced (Arrow_Angle);
         PR : Point_Array (P'First .. P'Last);
      begin
         if Arrow_Len = 0.0 then
            return 0.0;
         end if;
         if Relative then
            for I in P'Range loop
               if I = P'First then
                  ...
                  PR (I).X := PR (I - 1).X + P (I).X;
                  PR (I).Y := PR (I - 1).Y + P (I).Y;
               end if;
            end loop;
         else
            PR := P;
         ...
         case Routing is
            when Straight =>
               return Pi + Arctan (PR (PR'First), PR (PR'First + 1));
            when Orthogonal =>
               if Side_From = Bottom then
                  if No_Waypoints then
                     return Arctan (PR (PR'First), PR (PR'First + 1));
                  else
                     return Arctan (PR (PR'First), PR (PR'First + 1));
                  end if;
               else
      ...
      end Compute_Angle_From;

      function Compute_Angle_To
        (P            : Point_Array; Relative : Boolean;
         Arrow_Len    : Gdouble;
         Arrow_Angle  : Gdouble;
         Routing      : Route_Style;
      ...
      begin
         ...
         case Routing is
            when Straight =>
               return Pi + Arctan (PR (PR'Last), PR (PR'Last - 1));
            when Orthogonal =>
               if Side_To = Bottom then
                  if No_Waypoints then
                     return Arctan (PR (PR'Last), PR (PR'Last - 1));
                  else
                     return Arctan (PR (PR'Last), PR (PR'Last - 1));
                  end if;
               else
      ...
      begin
         ...
         case Self.Head is
            ...
            when Circle =>
               Save (Cr);
               Arc
                 (Cr, Xc => To.X, Yc => To.Y, Radius => Self.Length,
                  Angle1 => 0.0, Angle2 => 2.0 * Pi);
   ...
   begin
      ...
      then
         Angle :=
           Compute_Angle_From
             (Points, Relative,
              Self.Data.Arrow_From.Length,
              Self.Data.Arrow_From.Angle,
              Routing,
              No_Waypoints);
         ...
         if Self.Data.Arrow_From.Head /= None then
            Draw_Arrow
              (Self.Data.Arrow_From, Cr, To => Points (Points'First),
               Angle                        => Angle);
         end if;
      end if;
      ...
      then
         if Relative then
            ...
            Angle := Compute_Angle_To (Points, Relative,
                                       Self.Data.Arrow_To.Length,
                                       Self.Data.Arrow_To.Angle,
                                       Routing,
                                       No_Waypoints);
         else
         ...
         if Self.Data.Arrow_To.Head /= None then
            Draw_Arrow (Self.Data.Arrow_To, Cr, To => To, Angle => Angle);
         end if;
      end if;
   ...
   procedure Measure_Text
     (Self   : Drawing_Style;
      Layout : not null access Pango.Layout.Pango_Layout_Record'Class;
      Text   : String; Width : out Glib.Gdouble; Height : out Glib.Gdouble)
   is
   ...
   procedure Draw_Text
     (Self       : Drawing_Style; Cr : Cairo.Cairo_Context;
      Layout     : not null access Pango.Layout.Pango_Layout_Record'Class;
      Topleft    : Point; Text : String;
   ...
   begin
      ...
      if Self.Data /= null and then Self.Data.Fill /= Cairo.Null_Pattern then
         --  for shadows:
   ...
   begin
      return
        Font_Style'
          (Name          => Copy (Source.Name), Underline => Source.Underline,
           Strikethrough => Source.Strikethrough, Color => Source.Color,
           Line_Spacing  => Source.Line_Spacing, Halign => Source.Halign);
   end Copy;
   ...
   procedure Set_Fill
     (Self : Drawing_Style; Fill : Cairo.Cairo_Pattern := Cairo.Null_Pattern)
   is
   begin
      if Self.Data /= null then
         Self.Data.Fill := Fill;
   ...
   procedure Set_Stroke
     (Self : Drawing_Style; Stroke : Gdk.RGBA.Gdk_RGBA := Gdk.RGBA.Black_RGBA)
   is
   begin
      if Self.Data /= null then
