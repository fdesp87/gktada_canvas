...
package body Gtkada.Canvas_Model_Pkg.Layers is
   ...
   is
      ...
      package Items_Maps is new Ada.Containers.Hashed_Maps
        (Key_Type        => Abstract_Item,
         ...
         Hash            => Canvas_Abstract_Item_Pkg.Hash,
         Equivalent_Keys => "=");
      use Items_Maps;
      ...
      begin
         ...
         --  Ignore link-to-link
         if Canvas_Link (It).Get_From.Is_Link
           or else Canvas_Link (It).Get_To.Is_Link
         then
            return;
         end if;
         ...
         V1 := Items.Element (Canvas_Link (It).Get_From.Get_Toplevel_Item);
         V2 := Items.Element (Canvas_Link (It).Get_To.Get_Toplevel_Item);
         E := new Canvas_Edge;
...
end Gtkada.Canvas_Model_Pkg.Layers;
