...
package Gtkada.Canvas_View_Pkg.Views is
   ...
   Default_Current_Region_Style : constant Gtkada.Style_Pkg.Drawing_Style :=
     Gtkada.Style_Pkg.Gtk_New
       (Stroke     => (0.0, 0.0, 0.0, 1.0),
        Fill       => Gtkada.Style_Pkg.Create_Rgba_Pattern ((0.9, 0.9, 0.9, 0.2)),
        Line_Width => 2.0);
...
private
   type Minimap_View_Record is new Canvas_View_Record with record
      ...
      Area_Style          : Gtkada.Style_Pkg.Drawing_Style;
